...
export namespace Prisma {
  ...
  */
  ...
  export type MoodOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "type" | "date" | "userId", ExtArgs["result"]["mood"]>
  ...
  interface MoodFieldRefs {
    ...
    readonly type: FieldRef<"Mood", 'String'>
  ...
  export type JournalOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "content" | "date" | "userId", ExtArgs["result"]["journal"]>
  ...
  export type MoodScalarWhereWithAggregatesInput = {
    ...
    type?: StringWithAggregatesFilter<"Mood"> | string
